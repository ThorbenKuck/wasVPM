...
$home_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/index.php";
$new_date_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/newdate/new.php";
$upload_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/newdate/upload.php";
$delete_one = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/delete/one.php";
$reset_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/delete/all.php";
$calc_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/newdate/calc.php";
$download_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/download/index.php";
$stand_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/current/stand.php";
$logout_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/user/logout.php";
$admin_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/user/admin.php";
$help_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/user/help.php";
$settings_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/user/settings.php";
$impressum_nav = str_replace(\Main\info()['root_path'], "", \Main\info()['active_theme_path']) . "/impressum/impressum.php";
