...
if(isset($path_to_include)) {
	...
	}else if(!empty(\Main\info())) {
		$path_to_include = \Main\info()['active_theme_path'] . $path_to_include;
	} else if(isset($_SESSION['active_theme']) && $_SESSION['active_theme'] != \Main\info()['active_theme_path']) {
...
<script>
<?php 
$to_index = \Main\info()['themes_root_package_name'] . "/" . \Main\info()['active_theme_name'] . "/index.php";
