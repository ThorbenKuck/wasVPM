...
<table border="2">
	<tr>
		...
		<th><b><?php echo $core[$number][0];?> </b></th>
	</tr>
	<tr>
		<th>Start Datum der Veranstaltung</th>
		<th><b><?php echo $core[$number][1];?> </b></th>
	</tr>
	<tr>
		<th>Start Zeitpunkt der Veranstaltung</th>
		<th><b><?php echo $core[$number][2];?> </b></th>
	</tr>
	<tr>
		<th>End Datum der Veranstaltung</th>
		<th><b><?php echo $core[$number][3];?> </b></th>
	</tr>
	<tr>
		<th>End Zeitpunkt der Veranstaltung</th>
		<th><b><?php echo $core[$number][4]?> </b></th>
	</tr>
</table>
<?php
			}
	...
	// ###################################
		...
		while ( $jahr <= $jahr_check ) {
			$feiertage = Vpm\free_days_to_array ( $jahr );
	...
	// #############
		...
		$login_try_res = \Users\login_user ( $username, $password, $keep_logdin );
		if ($login_try_res) {
			if (\Users\is_logdin ()) {
	...
	// #############
		...
		if(\Users\logout_user()) {
			if(!\Users\is_logdin()) {
				...
				echo "Es gab einen kritischen Fehler bei der Validierung ihrer Abmeldung. Bitte laden sie die Seite neu und versuchen sie es erneut!";
			}
		} else {
